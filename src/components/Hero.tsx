            ...
            <CCarouselItem key={index} className="">
              ...
              <CCarouselCaption className="-ml-10 max-w-56 mb-4 sm:max-w-80 sm:mb-96 xl:mb-[300px] text-start lg:max-w-lg ">
                ...
                <div className="flex gap-1">
                  <Button
                    variant={"outline"}
                    className="bg-black mr-4 border-blue-500 text-blue-400 rounded-xl hover:bg-black hover:text-primary hover:opacity-90 sm:mb-16 sm:mt-8 md:mb-5 xl:mb-52 no-underline"
                    size={"lg"}
                    asChild
                  >
                  ...
                  <Button
                    variant={"outline"}
                    className="bg-black hidden sm:inline-block pt-2 border-blue-500 text-blue-400 rounded-xl hover:bg-black hover:text-primary hover:opacity-90 sm:mb-16 sm:mt-8 md:mb-5 xl:mb-52 no-underline "
                    size={"lg"}
                    asChild
                  >
